...
- **History, undo, reset** — every hand logged newest-first; Undo restores the previous dealer/wind; game state persists in your browser (localStorage) across reloads.
